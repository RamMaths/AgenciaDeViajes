  ...
  const handleSubmit = e => {
    ...
    postRequest(
      tableLinks['Hoteles'][0],
      {
        ...
        id_ciudad: cities[city],
        direccion: formObj.direccion
      },
      res => {
        handleClose();
        handleRefresh();
      ...
      <Modal.Body className='mt-0' style={{marginTop: '0'}}>
        ...
        <Form onSubmit={handleSubmit}>
          <Form.Group className='m-3 mb-4'>
            <Row>
              <Form.Label className='ps-0'>Nombre del hotel</Form.Label>
              <Form.Control name='nombre' type='text'>
              </Form.Control>
              <Form.Label className='ps-0 mt-3'>Dirección</Form.Label>
              <Form.Control name='direccion' type='text'>
              </Form.Control>
            </Row>
          </Form.Group>
          <Row>
